    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        {
            View view = hasViews.findViewById(id.serverMode);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        MainActivity_.this.goServerMode();
                    }
        ...
        {
            View view = hasViews.findViewById(id.clientMode);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MainActivity_.this.goClientMode();
                    }
