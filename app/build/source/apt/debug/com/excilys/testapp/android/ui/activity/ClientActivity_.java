    ...
    implements HasViews
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_client);
    }
    ...
    public static ClientActivity_.IntentBuilder_ intent(Fragment supportFragment) {
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ClientActivity_.class);
        }

        public IntentBuilder_(Fragment fragment) {
            fragmentSupport_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, ClientActivity_.class);
        }
        ...
        public ClientActivity_.IntentBuilder_ flags(int flags) {
